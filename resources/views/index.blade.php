...
@section('content')
    <div class="no-class ">
        <div class="">
            ...
            <div style="width: 100%; height: 20px; border-bottom: 1px solid rgba(255,0,0,0.22); text-align: center">
                  <span style="font-size: 20px; background-color: #f3f3f3; padding: 0 20px; ">
                    <b class="font-bg hd-cl">បញ្ចប់ការដេញថ្លៃ</b>
                  </span>
            </div>
            <br>
        </div>
        <div class="row ">
            ...
            @foreach($finish_pro as $f_item)
            <div class="col-sm-6 col-md-3">
                <div class="deal-entry">
                    <img class="pull-right" src="{{url('storage/icons/alert_pro_yellow.png')}}" alt="">
                    <div class="title mid">
                        <a class="max-lines" href="{{url('/product/'.$f_item->gen_key)}}"  >
                            {{$f_item->name}}
                        </a>
                    </div>

                    <div class="image mid" >
                        <a href="{{url('/product/'.$f_item->gen_key)}}"  >
                            <img class="img-fluid" src="{{url('storage/'.$f_item->image)}}" alt="#"  >
                        </a>
                    </div>
                    <!-- /.image -->

                    <div class="entry-content mid">
                        <h3 class="df-cl font-bg"> @if(!empty($f_item->auctions->last()->price))
                                {{ number_format($f_item->auctions->last()->price, 0) }}
                            @else
                                {{ number_format($f_item->price, 0) }}
                            @endif KHR</h3>
                        ...
                        <b class="df-cl font-bg price-font">ថ្ងៃទី {{$f_item->end_date}}</b>
                    </div>
                    <!--/.entry content -->

                    <a  class="button circle" style="margin-bottom: 30px;cursor: default" href="javascript:void(0)"><b class="font-bg" style="color: #fff;cursor: default">ដេញថ្លៃ</b></a>
            ...
            <div class="col-sm-6 col-md-3">
                ...
                <script>
                    ...
                    $(function () {
                       ...
                       // var end = new Date(timer_month,timer_day,timer_year,timer_hour,timer_min);
